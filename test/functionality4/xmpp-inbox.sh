...
mark_displayed () {
  ...
  local query="
    <message to='${toUuid}@bunk-app.in' from='${fromUuid}@bunk-app.in'>
...
<message xmlns="jabber:client" from="$user1uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="1" queryid="$query_id_1"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user2uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1" type="chat"><body>from user 2 to user 1</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>false</read><box>inbox</box><archive>false</archive><mute>0</mute></result></message>
<message xmlns="jabber:client" from="$user1uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="1" queryid="$query_id_1"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user3uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1" type="chat"><body>from user 3 to user 1</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>false</read><box>inbox</box><archive>false</archive><mute>0</mute></result></message>
<iq id="$query_id_1" type="result"><fin/></iq>
EOF
)

expected_inbox_2=$(cat << EOF
<message xmlns="jabber:client" from="$user2uuid@bunk-app.in" to="$user2uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="0" queryid="$query_id_2"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user2uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1" type="chat"><body>from user 2 to user 1</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>true</read><box>chats</box><archive>false</archive><mute>0</mute></result></message>
<message xmlns="jabber:client" from="$user2uuid@bunk-app.in" to="$user2uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="1" queryid="$query_id_2"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user3uuid@bunk-app.in" to="$user2uuid@bunk-app.in" id="id1" type="chat"><body>from user 3 to user 2</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>false</read><box>chats</box><archive>false</archive><mute>0</mute></result></message>
<iq id="$query_id_2" type="result"><fin/></iq>
EOF
)

expected_inbox_3=$(cat << EOF
<message xmlns="jabber:client" from="$user3uuid@bunk-app.in" to="$user3uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="0" queryid="$query_id_3"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user3uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1" type="chat"><body>from user 3 to user 1</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>true</read><box>chats</box><archive>false</archive><mute>0</mute></result></message>
<message xmlns="jabber:client" from="$user3uuid@bunk-app.in" to="$user3uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="0" queryid="$query_id_3"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user3uuid@bunk-app.in" to="$user2uuid@bunk-app.in" id="id1" type="chat"><body>from user 3 to user 2</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>true</read><box>chats</box><archive>false</archive><mute>0</mute></result></message>
...
actual_inbox_1=$(get_inbox "$user1uuid" "$user1token"); query_id_1=$(query_id)
expected_inbox_1=$(cat << EOF
<message xmlns="jabber:client" from="$user1uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="0" queryid="$query_id_1"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user2uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1" type="chat"><body>from user 2 to user 1</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>true</read><box>inbox</box><archive>false</archive><mute>0</mute></result></message>
<message xmlns="jabber:client" from="$user1uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1"><result xmlns="erlang-solutions.com:xmpp:inbox:0" unread="1" queryid="$query_id_1"><forwarded xmlns="urn:xmpp:forward:0"><delay xmlns="urn:xmpp:delay" stamp="redacted"/><message xmlns="jabber:client" from="$user3uuid@bunk-app.in" to="$user1uuid@bunk-app.in" id="id1" type="chat"><body>from user 3 to user 1</body><request xmlns="urn:xmpp:receipts"/></message></forwarded><read>false</read><box>inbox</box><archive>false</archive><mute>0</mute></result></message>
<iq id="$query_id_1" type="result"><fin/></iq>
EOF
)
