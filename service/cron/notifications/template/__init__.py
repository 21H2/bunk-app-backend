...
def frequency_url(email, type, frequency):
    base_url = 'https://api.bunk-app.in/update-notifications'
    params = {
        'email': email,
        'type': type,
        'frequency': frequency
        ...
        <tr>
            <td align="center">
                <table style="max-width: 600px; width: 100%;" cellspacing="0" cellpadding="0" border="0" align="center">
                    ...
                    <tr>
                        <td bgcolor="#f1e5ff" align="center" style="color: #FF6190; padding-left: 20px; padding-right: 20px; padding-bottom: 40px;">
                            <p style="color: #FF6190; font-size: 24px; font-weight: 900;">{big_part(has_intro, has_chat)}</p>
                            <p style="color: #FF6190; font-size: 16px">{little_part(has_intro, has_chat)}</p>
                        </td>
                    </tr>
                    <tr>
